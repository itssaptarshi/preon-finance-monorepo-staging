...
import { Decimal, YUSD_MINIMUM_NET_DEBT, Trove } from "@liquity/lib-base";

import App from "./App";

const params = { depositCollateral: Decimal.from(20), borrowYUSD: YUSD_MINIMUM_NET_DEBT };
...
test("there's no smoke", async () => {
  ...
  expect(await findByText(/you can borrow yusd by opening a trove/i)).toBeInTheDocument();
