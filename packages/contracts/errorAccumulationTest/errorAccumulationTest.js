...
contract("TroveManager", async (accounts) => {
  ...
  */
  ...
  /* ABDK64, no error correction:
    ...
    STARDebt left in Default Pool is: 108
    ...
    STARDebt left in Default Pool is: 653
  */
  ...
  /* ABDK64, no error correction:
    ...
    STARDebt left in Default Pool is: 75
  ...
  */
  ...
  /* ABDK64, no error correction:
    ...
    STARDebt left in Default Pool is: 180
  ...
  */
  ...
  it("11 accounts. 10 liquidations. Check (ActivePool - DefaultPool) differences", async () => {
    ...
    let totalSTARDebtPoolDifference = web3.utils.toBN(0);

    for (account of accounts.slice(1, 11)) {
      const activePoolETH = await activePool.getCollateral(weth.address);
      const activePoolSTARDebt = await activePool.getSTAR();
      ...
      totalSTARDebtPoolDifference.add(
        activePoolSTARDebt.sub(defaultPoolSTARDebt)
      );
    }
    ...
    console.log(
      `Accumulated STARDebt difference between Active and Default Pools is: ${totalSTARDebtPoolDifference}`
    );
  });

  /* ABDK64, no error correction
    Accumulated ETH difference between Default and Active Pools is: 0
    Accumulated STARDebt difference between Active and Default Pools is: 0
  ...
  */
  ...
  it("11 accounts. 10 liquidations. Check (DefaultPool - totalRewards) differences", async () => {
    ...
    const L_STARDebt = await troveManager.L_STARDebt();
    ...
    const totalSTARRewards = totalColl.mul(L_STARDebt).div(_1e18_BN);

    const defaultPoolETH = await defaultPool.getCollateral(weth.address);
    const defaultPoolSTARDebt = await defaultPool.getSTARDebt();

    const ETHRewardDifference = defaultPoolETH.sub(totalETHRewards);
    const STARDebtRewardDifference = defaultPoolSTARDebt.sub(totalSTARRewards);

    console.log(
      `ETH difference between total pending rewards and DefaultPool: ${ETHRewardDifference} `
    );
    console.log(
      `STARDebt difference between total pending rewards and DefaultPool: ${STARDebtRewardDifference} `
    );
  });

  /* ABDK64, no error correction:
    ETH difference between total pending rewards and DefaultPool: 700
    STARDebt difference between total pending rewards and DefaultPool: 800

    ABDK64 WITH correction:
    ETH difference between total pending rewards and DefaultPool: 300
    STARDebt difference between total pending rewards and DefaultPool: 400
    
    DeciMath, no error correction:
    ETH difference between total pending rewards and DefaultPool: -100
    STARDebt difference between total pending rewards and DefaultPool: -200

    Pure division with correction: 
    ETH difference between total pending rewards and DefaultPool: 0
    STARDebt difference between total pending rewards and DefaultPool: 0
  */
  ...
  /* ABDK64, no error correction:
    ...
    STARDebt difference between total pending rewards and DefaultPool: 55000
    
    ABDK64 WITH correction:
    ETH difference between total pending rewards and DefaultPool: 31000
    STARDebt difference between total pending rewards and DefaultPool: 31000

    DeciMath, no error correction:
    ETH difference between total pending rewards and DefaultPool: 2000
    STARDebt difference between total pending rewards and DefaultPool: -2000
  ...
  */
  ...
  it("11 accounts with random ETH and proportional STAR (180:1). 10 liquidations. Check (DefaultPool - totalRewards) differences", async () => {
    await borrowerOperations.openTrove(0, 0, accounts[999], {
      from: accounts[999],
      value: dec(100, "ether"),
    });

    await th.openTrove_allAccounts_randomETH_ProportionalSTAR(
      1,
      2,
      accounts.slice(0, 11),
      contracts,
  ...
  /* ABDK64, no error correction:
    ...
    STARDebt difference between total pending rewards and DefaultPool: 8000

    ABDK64 WITH correction:
    ETH difference between total pending rewards and DefaultPool: 300
    STARDebt difference between total pending rewards and DefaultPool: 300
    ...
    Pure division with correction:
    ETH difference between total pending rewards and DefaultPool: 100
    STARDebt difference between total pending rewards and DefaultPool: 100
  */

  it("101 accounts with random ETH and proportional STAR (180:1). 100 liquidations. Check 1) (DefaultPool - totalDistributionRewards) difference, and 2) ", async () => {
    await borrowerOperations.openTrove(0, 0, accounts[999], {
      from: accounts[999],
      value: dec(1000, "ether"),
    });
  ...
  /* ABDK64, no error correction:
    ...
    STARDebt difference between total pending rewards and DefaultPool: 61000

    ABDK64 WITH correction:
    ETH difference between total pending rewards and DefaultPool: 31300
    STARDebt difference between total pending rewards and DefaultPool: 30000
    ...
    STARDebt difference between total pending rewards and DefaultPool: 1000
  */
  ...
  it("11 accounts. 10 liquidations, partial offsets. Check (DefaultPool - totalRewards) differences", async () => {
    // Acct 99 opens trove with 100 STAR
    await borrowerOperations.openTrove(0, 0, accounts[99], {
      from: accounts[99],
      value: dec(100, "ether"),
    });
    await borrowerOperations.withdrawSTAR(0, dec(100, 18), accounts[99], {
      from: accounts[99],
    });
    ...
    // On loop: Account[99] adds 10 STAR to pool -> a trove gets liquidated and partially offset against SP, emptying the SP
    for (account of accounts.slice(1, 11)) {
    ...
    const totalSTARRewards_Distribution = totalColl
      .mul(L_STARDebt)
      .div(_1e18_BN);
    ...
    const STARDebtRewardDifference = defaultPoolSTARDebt.sub(
      totalSTARRewards_Distribution
    );
    ...
    console.log(
      `STARDebt difference between total pending distribution rewards and DefaultPool: ${STARDebtRewardDifference} `
    );
  });

  /* ABDK64, no error correction
    ETH difference between total pending distribution rewards and DefaultPool: 550
    STARDebt difference between total pending distribution rewards and DefaultPool: 600
    
    DeciMath, no error correction:
    ETH difference between total pending distribution rewards and DefaultPool: 150
    STARDebt difference between total pending distribution rewards and DefaultPool: -200
    
    Pure division with error correction:
    ETH difference between total pending distribution rewards and DefaultPool: 50
    STARDebt difference between total pending distribution rewards and DefaultPool: 0
  */
  ...
  it("101 accounts. 100 liquidations, partial offsets. Check (DefaultPool - totalRewards) differences", async () => {
    ...
    await borrowerOperations.withdrawSTAR(0, dec(100, 18), accounts[999], {
      from: accounts[999],
    });
  ...
  /* ABDK64, no error correction
    ...
    STARDebt difference between total pending distribution rewards and DefaultPool: 8900
  ...
  */
  ...
  it("11 accounts. 10 Borrowers add to SP. 1 liquidation, 10 Borrowers withdraw all their SP funds", async () => {
    ...
    /* Sometimes, the error causes the last STAR withdrawal from SP to underflow and fail.
    ...
    const SP_STAR = await stabilityPool.getTotalSTARDeposits();

    const SP_STAR_Insufficiency = web3.utils.toBN(whaleSPDeposit).sub(SP_STAR);

    // check Stability Pool
    console.log(`Surplus ETH left in in Stability Pool is ${SP_ETH}`);
    console.log(
      `STAR insufficiency in Stability Pool is ${SP_STAR_Insufficiency}`
    );
  });

  /* ABDK64, no error correction
      Sometimes subtraction overflows on last withdrawal from SP - error leaves insufficient STAR in Pool.
      ...
      STAR insufficiency in Stability Pool is 530
      
      DeciMath, no error correction:
      Surplus ETH left in in Stability Pool is 0
      STAR insufficiency in Stability Pool is 0
  ...
  /* ABDK64, no error correction
    ...
    STAR insufficiency in Stability Pool is 5300
  ...
  it("11 accounts. 10 Borrowers add to SP, random STAR amounts. 1 liquidation, 10 Borrowers withdraw all their SP funds", async () => {
    // Acct 99 opens trove with 100 STAR
    await borrowerOperations.openTrove(0, 0, accounts[999], {
      from: accounts[999],
      value: dec(100, "ether"),
  ...
  /* ABDK64, no error correction
      ...
      STAR insufficiency in Stability Pool is 442
      ...
      STAR insufficiency in Stability Pool is 67

      Pure division with error correction:
      Surplus ETH left in in Stability Pool is 446
      STAR insufficiency in Stability Pool is 507
    */

  it("101 accounts. 100 Borrowers add to SP, random STAR amounts. 1 liquidation, 100 Borrowers withdraw all their SP funds", async () => {
    // Acct 99 opens trove with 100 STAR
    await borrowerOperations.openTrove(0, 0, accounts[999], {
      from: accounts[999],
      value: dec(100, "ether"),
  ...
  /* ABDK64, no error correction
    ...
    STAR insufficiency in Stability Pool is 1112

    DeciMath, no error correction:
    Surplus ETH left in in Stability Pool is 1373
    STAR insufficiency in Stability Pool is -13

    Pure division with no error correction:
    Surplus ETH left in in Stability Pool is 4087
    STAR insufficiency in Stability Pool is 1960

    Pure division with error correction:
    Surplus ETH left in in Stability Pool is 3072
    STAR insufficiency in Stability Pool is 452
  */

  it("501 accounts. 500 Borrowers add to SP, random STAR amounts. 1 liquidation, 500 Borrowers withdraw all their SP funds", async () => {
    // Acct 99 opens trove with 100 STAR
    await borrowerOperations.openTrove(0, 0, accounts[999], {
      from: accounts[999],
      value: dec(100, "ether"),
  ...
  /* ABDK64, no error correction:
    ...
    STAR insufficiency in Stability Pool is -8445

    Pure division, no correction:
    Surplus ETH left in in Stability Pool is 18708
    STAR insufficiency in Stability Pool is 25427

    Pure division with error correction:
    Surplus ETH left in in Stability Pool is 1573
    STAR insufficiency in Stability Pool is 6037
  */
...
*/
  ...
  STARDebt left in Default Pool is: 308731912

  Pure division, correction:
  ETH left in Default Pool is: 1136050360
  STARDebt left in Default Pool is: 997601870

  Pure division, no correction:
  ETH left in Default Pool is: 810899932
  STARDebt left in Default Pool is: 535042995
*/
  ...
  STARDebt left in Default Pool is: 14696382412

  Pure division, correction:
  ETH left in Default Pool is: 9281255535
  STARDebt left in Default Pool is: 5854012464
  */
  ...
  it("11 accounts with random ETH and proportional STAR (180:1). 10 liquidations. Check (DefaultPool - totalRewards) differences", async () => {
    ...
    // Troves open with 100-200 million ether and proportional STAR Debt
    await th.openTrove_allAccounts_randomETH_ProportionalSTAR(
      100000000,
      200000000,
      accounts.slice(0, 11),
  ...
  STARDebt difference between total pending rewards and DefaultPool: 12000000000

  Pure division with correction:
  ETH difference between total pending rewards and DefaultPool: 1000000000
  STARDebt difference between total pending rewards and DefaultPool: 1000000000
  */
  ...
  /*
    ...
    STARDebt difference between total pending rewards and DefaultPool: 870000000000

    Pure division with correction:
    ETH difference between total pending rewards and DefaultPool: 10000000000
    STARDebt difference between total pending rewards and DefaultPool: 10000000000
  */
});
...
/* --- TODO:
 ...
 Test to see if error is stable or grows. 
  ...
  1) Reward applications accumulate ETH and STARDebt error in DefaultPool

  2) Liquidations accumulate ETH and STARDebt error in DefaultPool
  ...
  5) StabilityPool Withdrawals can accumulate STARLoss in the StabilityPool (i.e. they distribute too much STAR), and can block
