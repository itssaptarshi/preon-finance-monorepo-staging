 ...
 */
contract PriceFeedBase is IPriceFeed {
    ...
    function setParams(address _priceAggregatorAddress, string memory _name)
        external
    {
     ...
     * @dev Called by Preon functions that require a current price.
    ...
    /**
     * @notice Returns the latest price obtained from the Oracle.
     * @dev Called by Preon contracts that require a current price.
     * Also callable by anyone externally.
     *
     * View function
     *
