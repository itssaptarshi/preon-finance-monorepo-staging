...
abstract contract MultiRewardsPoolBase is
    Initializable,
    ...
    IMultiRewardsPool
{
    ...
    function registerRewardToken(address token) external override onlyOperator {
    ...
    function removeRewardToken(address token) external override onlyOperator {
