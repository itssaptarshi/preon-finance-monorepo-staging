...
// const WJLP = artifacts.require("../UnneededContracts/AssetWrappers/WJLP.sol");
// const WBQI = artifacts.require("../UnneededContracts/AssetWrappers/WBQI.sol");
// const WAAVE = artifacts.require("../UnneededContracts/AssetWrappers/WAAVE.sol");
// const WCRV = artifacts.require("../UnneededContracts/AssetWrappers/WCRV.sol");
...
class DeploymentHelper {
  ...
  static async deployNewRouter(contracts, params) {
    const { name, joeRouter, whitelistCollateral } = params;
    ...
    await contracts.whitelist.setDefaultRouter(
      whitelistCollateral.address,
      newERC20Router.address
    );
