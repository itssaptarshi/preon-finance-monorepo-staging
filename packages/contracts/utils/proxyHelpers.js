...
class BorrowerOperationsProxy extends Proxy {
  ...
  async withdrawSTAR(...params) {
    return this.forwardFunction(
      params,
      "withdrawSTAR(uint256,uint256,address,address)"
    );
  }

  async repaySTAR(...params) {
    return this.forwardFunction(params, "repaySTAR(uint256,address,address)");
  }
  ...
  async STAR_GAS_COMPENSATION(...params) {
    return this.proxyFunction("STAR_GAS_COMPENSATION", params);
  }
...
class TroveManagerProxy extends Proxy {
  ...
  async getPendingSTARDebtReward(...params) {
    return this.proxyFunction("getPendingSTARDebtReward", params);
  }
  ...
  async L_STARDebt() {
    return this.proxyFunction("L_STARDebt", []);
  }
...
class StabilityPoolProxy extends Proxy {
  ...
  async getCompoundedSTARDeposit(user) {
    return this.proxyFunctionWithUser("getCompoundedSTARDeposit", user);
  }
...
class SPREONProxy extends Proxy {
  constructor(owner, proxies, tokenScriptAddress, token) {
    super(owner, proxies, tokenScriptAddress, token);
  }
  ...
  async F_STAR(user) {
    return this.proxyFunctionWithUser("F_STAR", user);
  }
}
