...
contract("Gas cost tests", async (accounts) => {
  ...
  // it("", async () => {
  //   const message = 'openTrove(), single account, 0 existing Troves in system. Adds 10 ether and issues 100 STAR'
  ...
  // it("", async () => {
  //   const message = 'openTrove(), single account, 1 existing Trove in system. Adds 10 ether and issues 100 STAR'
  ...
  // it("", async () => {
  //   const message = 'openTrove(), single account, Inserts between 2 existing CDs in system. Adds 10 ether and issues 80 STAR. '
  ...
  // it("", async () => {
  //   const message = 'openTrove(), 10 accounts, each account adds 10 ether and issues 100 STAR'

  //   const amountETH = dec(10, 'ether')
  //   const amountSTAR = 0
  //   const gasResults = await th.openTrove_allAccounts(_10_Accounts, contracts, amountETH, amountSTAR)
  ...
  // it("", async () => {
  //   const message = 'openTrove(), 10 accounts, each account adds 10 ether and issues less STAR than the previous one'
  //   const amountETH = dec(10, 'ether')
  //   const amountSTAR = 200
  //   const gasResults = await th.openTrove_allAccounts_decreasingSTARAmounts(_10_Accounts, contracts, amountETH, amountSTAR)
  //   th.logGasMetrics(gasResults, message)
  //   th.logAllGasCosts(gasResults)
  ...
  it("", async () => {
    const message =
      "openTrove(), 50 accounts, each account adds random ether and random STAR";
    const amountETH = dec(10, "ether");
    const amountSTAR = 0;
    const gasResults = await th.openTrove_allAccounts_randomETH_randomSTAR(
      1,
      9,
      _50_Accounts,
      contracts,
  ...
  // it("", async () => {
  //   const message = 'adjustTrove(). ETH/STAR Increase/Increase. 10 accounts, each account adjusts up -  1 ether and 100 STAR'
  //   await borrowerOperations.openTrove(_100pct, 0, accounts[999], ZERO_ADDRESS, { from: accounts[999], value: dec(100, 'ether') })

  //   const amountETH = dec(10, 'ether')
  //   const amountSTAR = dec(100, 18)
  //   await th.openTrove_allAccounts(_10_Accounts, contracts, amountETH, amountSTAR)

  //   const amountETH_2 = dec(1, 'ether')
  //   const amountSTAR_2 = dec(100, 18)
  //   const gasResults = await th.adjustTrove_allAccounts(_10_Accounts, contracts, amountETH_2, amountSTAR_2)
  ...
  // it("", async () => {
  //   const message = 'adjustTrove(). ETH/STAR Decrease/Decrease. 10 accounts, each account adjusts down by 0.1 ether and 10 STAR'
  //   await borrowerOperations.openTrove(_100pct, 0, accounts[999], ZERO_ADDRESS, { from: accounts[999], value: dec(100, 'ether') })
  ...
  //   const amountSTAR_2 = "-10000000000000000000" // debt decrease of 10 STAR
  //   const gasResults = await th.adjustTrove_allAccounts(_10_Accounts, contracts, amountETH_2, amountSTAR_2)
  ...
  // it("", async () => {
  //   const message = 'adjustTrove(). ETH/STAR Increase/Decrease. 10 accounts, each account adjusts up by 0.1 ether and down by 10 STAR'
  //   await borrowerOperations.openTrove(_100pct, 0, accounts[999], ZERO_ADDRESS, { from: accounts[999], value: dec(100, 'ether') })
  ...
  //   const amountETH = dec(10, 'ether')
  //   const amountSTAR = dec(100, 18)
  //   await th.openTrove_allAccounts(_30_Accounts, contracts, amountETH, amountSTAR)

  //   // Randomly add between 1-9 ETH, and withdraw 1-100 STAR
  ...
  it("", async () => {
    ...
    await borrowerOperations.openTrove(
      ...
      accounts[999],
      ZERO_ADDRESS,
      { from: accounts[999], value: dec(100, "ether") }
    );
  ...
  it("", async () => {
    ...
    await th.openTrove_allAccounts_decreasingSTARAmounts(
      _10_Accounts,
      contracts,
      dec(10, "ether"),
      200
    ...
    for (account of _10_Accounts) {
      await starToken.unprotectedMint(account, dec(1000, 18));
    }
  ...
  it("", async () => {
    const message =
      "closeTrove(), 20 accounts, each account adds 10 ether and issues less STAR than the previous one. First 10 accounts close their trove. ";
  ...
  // it("", async () => {
  //   const message = 'withdrawSTAR(), first withdrawal, 10 accounts, each account withdraws 100 STAR'
  //   await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)

  //   const gasResults = await th.withdrawSTAR_allAccounts(_10_Accounts, contracts, dec(100, 18))
  //   th.logGasMetrics(gasResults, message)
  //   th.logAllGasCosts(gasResults)
  ...
  // it("", async () => {
  //   const message = 'withdrawSTAR(), second withdrawal, 10 accounts, each account withdraws 100 STAR'
  //   await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)
  //   await th.withdrawSTAR_allAccounts(_10_Accounts, contracts, dec(100, 18))
  ...
  it("", async () => {
    const message =
      "withdrawSTAR(), first withdrawal, 30 accounts, each account withdraws a random STAR amount";
    await th.openTrove_allAccounts(
      _30_Accounts,
      contracts,
      dec(10, "ether"),
    ...
    const gasResults = await th.withdrawSTAR_allAccounts_randomAmount(
      1,
      180,
      _30_Accounts,
      contracts
  ...
  it("", async () => {
    const message =
      "withdrawSTAR(), second withdrawal, 30 accounts, each account withdraws a random STAR amount";
    await th.openTrove_allAccounts(
      _30_Accounts,
      contracts,
      dec(10, "ether"),
    ...
    await th.withdrawSTAR_allAccounts(_30_Accounts, contracts, dec(100, 18));
  ...
  // it("", async () => {
  //   const message = 'repaySTAR(), partial repayment, 10 accounts, repay 30 STAR (of 100 STAR)'
  //   await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)
  //   await th.withdrawSTAR_allAccounts(_10_Accounts, contracts, dec(100, 18))

  //   const gasResults = await th.repaySTAR_allAccounts(_10_Accounts, contracts, dec(30, 18))
  //   th.logGasMetrics(gasResults, message)
  //   th.logAllGasCosts(gasResults)
  ...
  // it("", async () => {
  //   const message = 'repaySTAR(), second partial repayment, 10 accounts, repay 30 STAR (of 70 STAR)'
  //   await th.openTrove_allAccounts(_30_Accounts, contracts, dec(10, 'ether'), 0)
  //   await th.withdrawSTAR_allAccounts(_30_Accounts, contracts, dec(100, 18))
  //   await th.repaySTAR_allAccounts(_30_Accounts, contracts, dec(30, 18))

  //   const gasResults = await th.repaySTAR_allAccounts(_30_Accounts, contracts, dec(30, 18))
  //   th.logGasMetrics(gasResults, message)
  //   th.logAllGasCosts(gasResults)
  ...
  it("", async () => {
    const message =
      "repaySTAR(), partial repayment, 30 accounts, repay random amount of STAR (of 100 STAR)";
    await th.openTrove_allAccounts(
      _30_Accounts,
      contracts,
      dec(10, "ether"),
    ...
    const gasResults = await th.repaySTAR_allAccounts_randomAmount(
      1,
      99,
      _30_Accounts,
      contracts
  ...
  // it("", async () => {
  //   const message = 'repaySTAR(), first repayment, 10 accounts, repay in full (100 of 100 STAR)'
  //   await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)
  //   await th.withdrawSTAR_allAccounts(_10_Accounts, contracts, dec(100, 18))

  //   const gasResults = await th.repaySTAR_allAccounts(_10_Accounts, contracts, dec(100, 18))
  //   th.logGasMetrics(gasResults, message)
  //   th.logAllGasCosts(gasResults)
  ...
  it("", async () => {
    const message =
      "repaySTAR(), first repayment, 30 accounts, repay in full (50 of 50 STAR)";
    await th.openTrove_allAccounts(
      _30_Accounts,
      contracts,
      dec(10, "ether"),
    ...
    await th.withdrawSTAR_allAccounts(_30_Accounts, contracts, dec(100, 18));
    await th.repaySTAR_allAccounts(_30_Accounts, contracts, dec(50, 18));

    const gasResults = await th.repaySTAR_allAccounts(
      _30_Accounts,
      contracts,
      dec(50, 18)
    );
  ...
  it("", async () => {
    ...
    const randSTARAmount = th.randAmountInWei(1, 180);
  ...
  it("", async () => {
    const message =
      "getCurrentICR(), Troves with 10 ether and 100 STAR withdrawn";
    await th.openTrove_allAccounts(
      _10_Accounts,
      contracts,
      dec(10, "ether"),
  ...
  it("", async () => {
    const message =
      "getCurrentICR(), Troves with 10 ether and random STAR amount withdrawn";
    await th.openTrove_allAccounts(
      _10_Accounts,
      contracts,
      dec(10, "ether"),
    ...
    await th.withdrawSTAR_allAccounts_randomAmount(
      1,
      1300,
      _10_Accounts,
      contracts
  ...
  it("", async () => {
    ...
    await borrowerOperations.openTrove(
      ...
      accounts[1],
      ZERO_ADDRESS,
      { from: accounts[1], value: dec(10, "ether") }
    );

    // acct 999 adds coll, withdraws STAR, sits at 111% ICR
    await borrowerOperations.openTrove(
      _100pct,
      dec(130, 18),
      accounts[999],
      ZERO_ADDRESS,
      { from: accounts[999], value: dec(1, "ether") }
    );
  ...
  it("", async () => {
    const message =
      "getCurrentICR(), Troves with 10 ether and 100 STAR withdrawn, WITH pending rewards";
    await th.openTrove_allAccounts(
      _10_Accounts,
      contracts,
      dec(10, "ether"),
  ...
  it("", async () => {
    const message =
      "getCurrentICR(), Troves with 10 ether and random STAR amount withdrawn, WITH pending rewards";
    await th.openTrove_allAccounts(
      _10_Accounts,
      contracts,
      dec(10, "ether"),
  ...
  it("", async () => {
    const message =
      "redeemCollateral(), redeems 50 STAR, redemption hits 1 Trove. One account in system, partial redemption";
    await th.openTrove_allAccounts(
      [accounts[0]],
      contracts,
      dec(10, "ether"),
    ...
    await th.withdrawSTAR_allAccounts([accounts[0]], contracts, dec(100, 18));
  ...
  it("", async () => {
    const message =
      "redeemCollateral(), redeems 50 STAR, redemption hits 1 Trove. No pending rewards. 3 accounts in system, partial redemption";
    // 3 accounts add coll
    await th.openTrove_allAccounts(
      accounts.slice(0, 3),
      contracts,
    ...
    // 3 accounts withdraw successively less STAR
    await borrowerOperations.withdrawSTAR(
      _100pct,
      dec(100, 18),
      accounts[0],
    ...
    /* Account 2 redeems 50 STAR. It is redeemed from account 0's Trove,
    leaving the Trove active with 30 STAR and ((200 *10 - 50 ) / 200 ) = 9.75 ETH.
  ...
  it("", async () => {
    const message =
      "redeemCollateral(), redeemed 101 STAR, redemption hits 2 Troves, last redemption is partial";
    await th.openTrove_allAccounts(
      _10_Accounts,
      contracts,
      dec(10, "ether"),
    ...
    // Whale adds 200 ether, withdraws 500 STAR, redeems 101 STAR
  ...
  it("", async () => {
    const message =
      "redeemCollateral(), redeemed 500 STAR, redemption hits 5 Troves, all full redemptions";
    await th.openTrove_allAccounts(
      _10_Accounts,
      contracts,
      dec(10, "ether"),
    ...
    // Whale adds 200 ether, withdraws 500 STAR, redeems 500 STAR
    await borrowerOperations.openTrove(_100pct, 0, whale, ZERO_ADDRESS, {
      from: whale,
      value: dec(200, "ether"),
    });
  ...
  it("", async () => {
    const message =
      "redeemCollateral(), redeemed 450 STAR, redemption hits 5 Troves,  last redemption is partial (50 of 100 STAR)";
    await th.openTrove_allAccounts(
      _10_Accounts,
      contracts,
      dec(10, "ether"),
    ...
    // Whale adds 200 ether, withdraws 450 STAR, redeems 500 STAR
    await borrowerOperations.openTrove(_100pct, 0, whale, ZERO_ADDRESS, {
      from: whale,
      value: dec(200, "ether"),
    });
  ...
  it("", async () => {
    const message =
      "redeemCollateral(), redeemed 1000 STAR, redemption hits 10 Troves";
    await th.openTrove_allAccounts(
      _10_Accounts,
      contracts,
      dec(10, "ether"),
    ...
    // Whale adds 200 ether, withdraws 1000 STAR, redeems 500 STAR
    await borrowerOperations.openTrove(_100pct, 0, whale, ZERO_ADDRESS, {
      from: whale,
      value: dec(200, "ether"),
    });
  ...
  it("", async () => {
    const message =
      "redeemCollateral(), redeemed 1500 STAR, redemption hits 15 Troves";
    await th.openTrove_allAccounts(
      _20_Accounts,
      contracts,
      dec(10, "ether"),
    ...
    await th.withdrawSTAR_allAccounts(_20_Accounts, contracts, dec(100, 18));

    // Whale adds 200 ether, withdraws 1500 STAR, redeems 1500 STAR
    await borrowerOperations.openTrove(_100pct, 0, whale, ZERO_ADDRESS, {
      from: whale,
      value: dec(200, "ether"),
    });
  ...
  it("", async () => {
    const message =
      "redeemCollateral(), redeemed 2000 STAR, redemption hits 20 Troves";
    await th.openTrove_allAccounts(
      _30_Accounts,
      contracts,
      dec(10, "ether"),
    ...
    // Whale adds 200 ether, withdraws 2000 STAR, redeems 2000 STAR
    await borrowerOperations.openTrove(_100pct, 0, whale, ZERO_ADDRESS, {
      from: whale,
      value: dec(200, "ether"),
    });
  ...
  // it("", async () => {
  //   const message = 'redeemCollateral(),  STAR, each redemption only hits the first Trove, never closes it'
  //   await th.addColl_allAccounts(_20_Accounts, troveManager, dec(10, 'ether'))
  //   await th.withdrawSTAR_allAccounts(_20_Accounts, troveManager, dec(100, 18))
  ...
  it("", async () => {
    const message =
      "redeemCollateral(), redeems 50 STAR, redemption hits 1 Trove, WITH pending rewards. One account in system";
    await th.openTrove_allAccounts(
      [accounts[1]],
      contracts,
      dec(10, "ether"),
    ...
    // acct 998 adds coll, withdraws STAR, sits at 111% ICR
    await th.openTrove_allAccounts(
      [accounts[998]],
      contracts,
      dec(1, "ether"),
  ...
  it("", async () => {
    const message =
      "redeemCollateral(), redeems 50 STAR, redemption hits 1 Trove. WITH pending rewards. 3 accounts in system.";
    // 3 accounts add coll
    await th.openTrove_allAccounts(
      accounts.slice(0, 3),
      contracts,
  ...
  it("", async () => {
    const message =
      "redeemCollateral(), redeemed 500 STAR, WITH pending rewards, redemption hits 5 Troves, WITH pending rewards";
    await th.openTrove_allAccounts(
      _10_Accounts,
      contracts,
      dec(10, "ether"),
  ...
  it("", async () => {
    const message =
      "redeemCollateral(), redeemed 1000 STAR, WITH pending rewards, redemption hits 10 Troves, WITH pending rewards";
    await th.openTrove_allAccounts(
      _10_Accounts,
      contracts,
      dec(10, "ether"),
  ...
  it("", async () => {
    const message =
      "redeemCollateral(), redeemed 1500 STAR, WITH pending rewards, redemption hits 15 Troves, WITH pending rewards";
    await th.openTrove_allAccounts(
      _20_Accounts,
      contracts,
      dec(10, "ether"),
  ...
  it("", async () => {
    const message =
      "redeemCollateral(), redeemed 2000 STAR, WITH pending rewards, redemption hits 20 Troves, WITH pending rewards";
    await th.openTrove_allAccounts(
      _30_Accounts,
      contracts,
      dec(10, "ether"),
  ...
  // it("", async () => {
  //   const message = 'redeemCollateral(),  STAR, each redemption only hits the first Trove, never closes it, WITH pending rewards'
  //   await th.addColl_allAccounts(_20_Accounts, troveManager, dec(10, 'ether'))
  //   await th.withdrawSTAR_allAccounts(_20_Accounts, troveManager, dec(100, 18))

  //    // acct 999 adds coll, withdraws STAR, sits at 111% ICR
  //    await borrowerOperations.addColl(accounts[999], {from: accounts[999], value:dec(1, 'ether')})
  //    await borrowerOperations.withdrawSTAR(_100pct, dec(130, 18), accounts[999], ZERO_ADDRESS, { from: accounts[999]})
  ...
  //   await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0 )
  //   await th.withdrawSTAR_allAccounts_randomAmount(1, 180, _10_Accounts, borrowerOperations)
  ...
  //   await th.withdrawSTAR_allAccounts_randomAmount(1, 180, _10_Accounts, troveManager)
  ...
  // it("", async () => {
  //   const message = 'provideToSP(), No pending rewards, part of issued STAR: all accounts withdraw 180 STAR, all make first deposit, provide 100 STAR'
  //   await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)
  //   await th.withdrawSTAR_allAccounts(_10_Accounts, contracts, dec(130, 18))
  ...
  // it("", async () => {
  //   const message = 'provideToSP(), No pending rewards, all issued STAR: all accounts withdraw 180 STAR, all make first deposit, 180 STAR'
  //   await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)
  //   await th.withdrawSTAR_allAccounts(_10_Accounts, contracts, dec(130, 18))
  ...
  it("", async () => {
    const message =
      "provideToSP(), No pending rewards, all accounts withdraw 180 STAR, all make first deposit, random STAR amount";
    await th.openTrove_allAccounts(
      _10_Accounts,
      contracts,
      dec(10, "ether"),
  ...
  it("", async () => {
    const message =
      "provideToSP(), No pending rewards, deposit part of issued STAR: all accounts withdraw 180 STAR, all make second deposit, provide 50 STAR";
    await th.openTrove_allAccounts(
      _10_Accounts,
      contracts,
      dec(10, "ether"),
    ...
    // >>FF time and one account tops up, triggers PREON gains for all
    await th.fastForwardTime(
    ...
    // Check the other accounts have PREON gain
    for (account of _10_Accounts.slice(1)) {
      const PREONGain = await stabilityPool.getDepositorPREONGain(account);
      assert.isTrue(PREONGain.gt(toBN("0")));
    }
  ...
  // it("", async () => {
  //   const message = 'provideToSP(), No pending rewards, deposit all issued STAR: all accounts withdraw 180 STAR, make second deposit, provide 90 STAR'
  //   await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)
  //   await th.withdrawSTAR_allAccounts(_10_Accounts, contracts, dec(130, 18))
  //   await th.provideToSP_allAccounts(_10_Accounts, stabilityPool, dec(50, 18))
  ...
  it("", async () => {
    const message =
      "provideToSP(), No pending rewards, all accounts withdraw 180 STAR, make second deposit, random STAR amount";
    await th.openTrove_allAccounts(
      _10_Accounts,
      contracts,
      dec(10, "ether"),
  ...
  // it("", async () => {
  //   const message = 'provideToSP(), with pending rewards in system. deposit part of issued STAR: all accounts make second deposit, provide 50 STAR'
  //   // 9 accts each open Trove with 10 ether, withdraw 180 STAR, and provide 50 STAR to Stability Pool
  //   await th.openTrove_allAccounts(accounts.slice(2, 12), contracts, dec(10, 'ether'), 0)
  //   await th.withdrawSTAR_allAccounts(accounts.slice(2, 12), contracts, dec(130, 18))
  //   await th.provideToSP_allAccounts(accounts.slice(2, 12), stabilityPool, dec(50, 18))

  //   //1 acct open Trove with 1 ether and withdraws 170 STAR
  ...
  //   // Check accounts have PREON gains from liquidations
  ...
  //   // 9 active Troves top up their Stability Pool deposits with 50 STAR
  ...
  // it("", async () => {
  //   const message = 'provideToSP(), with pending rewards in system. deposit all issued STAR: all accounts make second deposit, provide 90 STAR'
  //   // 10 accts each open Trove with 10 ether, withdraw 180 STAR, and provide 90 STAR to Stability Pool
  //   await th.openTrove_allAccounts(accounts.slice(2, 12), contracts, dec(10, 'ether'), 0)
  //   await th.withdrawSTAR_allAccounts(accounts.slice(2, 12), contracts, dec(130, 18))
  //   await th.provideToSP_allAccounts(accounts.slice(2, 12), stabilityPool, dec(50, 18))

  //   //1 acct open Trove with 1 ether and withdraws 180 STAR
  //   await borrowerOperations.openTrove(_100pct, dec(130, 18), accounts[1], ZERO_ADDRESS, { from: accounts[1], value: dec(1, 'ether') })
  ...
  //   // 5 active Troves top up their Stability Pool deposits with 90 STAR, using up all their issued STAR
  ...
  it("", async () => {
    const message =
      "provideToSP(), with pending rewards in system. deposit part of issued STAR: all make second deposit, provide random STAR amount";
    // 10 accts each open Trove with 10 ether, withdraw 180 STAR, and provide 90 STAR to Stability Pool
    await th.openTrove_allAccounts(
      accounts.slice(2, 12),
      contracts,
    ...
    await borrowerOperations.openTrove(
      ...
      accounts[1],
      ZERO_ADDRESS,
      { from: accounts[1], value: dec(1, "ether") }
    );
    ...
    // 5 active Troves top up their Stability Pool deposits with a random STAR amount
    const gasResults = await th.provideToSP_allAccounts_randomAmount(
      1,
      49,
      accounts.slice(7, 12),
  ...
  // partial
  // it("", async () => {
  //   const message = 'withdrawFromSP(), no pending rewards. Stability Pool depositors make partial withdrawal - 90 STAR of 180 STAR deposit'
  ...
  it("", async () => {
    const message =
      "withdrawFromSP(), no pending rewards. Stability Pool depositors make full withdrawal - 130 STAR of 130 STAR deposit";
    await th.openTrove_allAccounts(
      _10_Accounts,
      contracts,
      dec(10, "ether"),
  ...
  it("", async () => {
    const message =
      "withdrawFromSP(), no pending rewards. Stability Pool depositors make partial withdrawal - random STAR amount, less than 180 STAR deposit";
    await th.openTrove_allAccounts(
      _10_Accounts,
      contracts,
      dec(10, "ether"),
  ...
  // it("", async () => {
  //   const message = 'withdrawFromSP(), pending rewards in system. Stability Pool depositors make partial withdrawal - 90 STAR of 130 STAR deposit'
  //   // 10 accts each open Trove with 10 ether, withdraw 180 STAR, and provide 180 STAR to Stability Pool
  ...
  //   await borrowerOperations.withdrawSTAR(_100pct, dec(130, 18), accounts[1], ZERO_ADDRESS, { from: accounts[1] })
  ...
  //   // 5 active Troves reduce their Stability Pool deposit by 90 STAR
  ...
  it("", async () => {
    const message =
      "withdrawFromSP(), pending rewards in system. Stability Pool depositors make full withdrawal - 130 STAR of 130 STAR deposit";
    // 10 accts each open Trove with 10 ether, withdraw 180 STAR, and provide 180 STAR to Stability Pool
    await th.openTrove_allAccounts(
      accounts.slice(2, 12),
      contracts,
    ...
    // 5 active Troves reduce their Stability Pool deposit by 130 STAR
    const gasResults = await th.withdrawFromSP_allAccounts(
      accounts.slice(7, 12),
      stabilityPool,
      dec(130, 18)
  ...
  it("", async () => {
    const message =
      "withdrawFromSP(), pending rewards in system. Stability Pool depositors make partial withdrawal - random amount of STAR";
    // 10 accts each open Trove with 10 ether, withdraw 180 STAR, and provide 130 STAR to Stability Pool
    await th.openTrove_allAccounts(
      accounts.slice(2, 12),
      contracts,
      dec(10, "ether"),
  ...
  // it("", async () => {
  //   const message = 'withdrawETHGainToTrove(), pending rewards in system. Accounts withdraw 180 STAR, provide 180 STAR, then withdraw all to SP after a liquidation'
  //   // 10 accts each open Trove with 10 ether, withdraw 180 STAR, and provide 130 STAR to Stability Pool
  //   await th.openTrove_allAccounts(accounts.slice(2, 12), contracts, dec(10, 'ether'), dec(130, 18))
  //   await th.provideToSP_allAccounts(accounts.slice(2, 12), stabilityPool, dec(130, 18))
  ...
  it("", async () => {
    const message =
      "withdrawETHGainToTrove(), pending rewards in system. Accounts withdraw 180 STAR, provide a random amount, then withdraw all to SP after a liquidation";
    // 20 accts each open Trove with 10 ether, withdraw 180 STAR, and provide 180 STAR to Stability Pool
    await th.openTrove_allAccounts(
      accounts.slice(2, 22),
      contracts,
      dec(10, "ether"),
  ...
  it("", async () => {
    ...
    // 10 accts each open Trove with 10 ether, withdraw 180 STAR
    await th.openTrove_allAccounts(
    ...
    await th.withdrawSTAR_allAccounts(
      accounts.slice(100, 110),
      contracts,
      dec(130, 18)
    );

    //6s acct open Trove with 1 ether and withdraw 180 STAR (inc gas comp)
    await th.openTrove_allAccounts(
      accounts.slice(0, 6),
      contracts,
      dec(1, "ether"),
  ...
  it("", async () => {
    ...
    // 100 accts each open Trove with 10 ether, withdraw 180 STAR
    await th.openTrove_allAccounts(
    ...
    // Accts open Trove with 1 ether and withdraws 180 STAR (inc gas comp)
    await th.openTrove_allAccounts(
  ...
  it("", async () => {
    ...
    //2 acct open Trove with 1 ether and withdraws 180 STAR (inc gas comp)
    await th.openTrove_allAccounts(
      accounts.slice(2, 4),
      contracts,
      dec(1, "ether"),
  ...
  it("", async () => {
    ...
    for (account of liquidationAcctRange) {
      ...
      await borrowerOperations.openTrove(
        ...
        account,
        ZERO_ADDRESS,
        { from: account, value: dec(1, "ether") }
      );
  ...
  it("", async () => {
    ...
    //3 acct open Trove with 1 ether and withdraws 180 STAR (inc gas comp)
    await th.openTrove_allAccounts(
      accounts.slice(0, 4),
      contracts,
      dec(1, "ether"),
    ...
    // Account 100 provides 600 STAR to pool
    await borrowerOperations.withdrawSTAR(
      _100pct,
      dec(600, 18),
      accounts[100],
  ...
  it("", async () => {
    ...
    // 5 acct open Trove with 1 ether and withdraws 180 STAR (inc gas comp)
    await th.openTrove_allAccounts(
      accounts.slice(0, 5),
      contracts,
      dec(1, "ether"),
    ...
    // Account 100 provides 360 STAR to SP
    await borrowerOperations.withdrawSTAR(
      _100pct,
      dec(600, 18),
      accounts[100],
  ...
  it("", async () => {
    ...
    //4 acct open Trove with 1 ether and withdraws 180 STAR (inc gas comp)
    await th.openTrove_allAccounts(
      accounts.slice(0, 4),
      contracts,
      dec(1, "ether"),
    ...
    // account 1 180 STAR liquidated  - partial offset
    const tx = await troveManager.liquidate(accounts[1], { from: accounts[0] });
    const gas = th.gasUsed(tx);
    th.logGas(gas, message);
  ...
  it("", async () => {
    ...
    // account 1 70 STAR liquidated  - partial offset against 50 STAR in SP
    const tx = await troveManager.liquidate(accounts[1], { from: accounts[0] });
    const gas = th.gasUsed(tx);
    th.logGas(gas, message);
  ...
  it("", async () => {
    ...
    //Account 99 and 98 each open Trove with 1 ether, and withdraw 180 STAR (inc gas comp)
    await th.openTrove_allAccounts(
      [accounts[99]],
      contracts,
      dec(1, "ether"),
    ...
    // Acct 99 deposits 1 STAR to SP
    await stabilityPool.provideToSP(dec(1, 18), ZERO_ADDRESS, {
      from: accounts[99],
    });

    //Account 97 opens Trove with 1 ether and withdraws 180 STAR (inc gas comp)
    await th.openTrove_allAccounts(
      [accounts[97]],
      contracts,
      dec(1, "ether"),
    ...
    // Acct 100 withdraws 1800 STAR and deposits it to the SP
    await borrowerOperations.withdrawSTAR(
      _100pct,
      dec(1750, 18),
      accounts[100],
    ...
    // Account 7 deposits 1 STAR in the Stability Pool
    await stabilityPool.provideToSP(dec(1, 18), ZERO_ADDRESS, {
      from: accounts[100],
    });
  ...
  it("", async () => {
    ...
    // 30 accts each open Trove with 10 ether, withdraw 180 STAR, and provide 180 STAR to Stability Pool
    await th.openTrove_allAccounts(
    ...
    //1 acct open Trove with 1 ether and withdraws 180 STAR (inc gas comp)
    await th.openTrove_allAccounts(
      [accounts[1]],
      contracts,
      dec(1, "ether"),
