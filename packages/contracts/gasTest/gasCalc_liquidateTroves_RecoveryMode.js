...
contract("Gas cost tests", async (accounts) => {
  ...
  it("", async () => {
    ...
    // 10 accts each open Trove with 10 ether, withdraw 900 STAR
    ...
    //1 accts open Trove with 1 ether and withdraw 100 STAR
    ...
    // Account 500 opens with 1 ether and withdraws 100 STAR
    await borrowerOperations.openTrove(
      _100pct,
      dec(60, 18),
      accounts[500],
      ZERO_ADDRESS,
      { from: accounts[500], value: dec(1, "ether") }
    );
    ...
    // Check initial troves with starting 10E/90STAR are still open
    for (account of accounts.slice(101, 111)) {
      assert.isTrue(await sortedTroves.contains(account));
    }
  ...
  it("", async () => {
    ...
    //2 accts open Trove with 1 ether and withdraw 100 STAR
  ...
  it("", async () => {
    ...
    //3 accts open Trove with 1 ether and withdraw 100 STAR
  ...
  it("", async () => {
    ...
    //5 accts open Trove with 1 ether and withdraw 100 STAR
  ...
  it("", async () => {
    ...
    //10 accts open Trove with 1 ether and withdraw 100 STAR
  ...
  it("", async () => {
    ...
    // 10 accts each open Trove with 10 ether, withdraw 90 STAR
    await th.openTrove_allAccounts(
      accounts.slice(101, 111),
      contracts,
      dec(10, "ether"),
    ...
    //20 accts open Trove with 1 ether and withdraw 100 STAR
  ...
  it("", async () => {
    ...
    //30 accts open Trove with 1 ether and withdraw 100 STAR
  ...
  it("", async () => {
    ...
    //40 accts open Trove with 1 ether and withdraw 100 STAR
  ...
  it("", async () => {
    ...
    //45 accts open Trove with 1 ether and withdraw 100 STAR
  ...
  it("", async () => {
    ...
    // Whale opens trove and fills SP with 1 billion STAR
    ...
    await borrowerOperations.openTrove(
      ...
      whale,
      ZERO_ADDRESS,
      { from: whale, value: dec(1, 27) }
    );
    await stabilityPool.provideToSP(dec(9, 28), ZERO_ADDRESS, { from: whale });

    // Check SP has 9e28 STAR
    const STARinSP = (await stabilityPool.getTotalSTARDeposits()).toString();
    assert.equal(STARinSP, dec(9, 28));

    //1 acct opens Trove with 1 ether and withdraw 100 STAR
    const _1_Defaulter = accounts.slice(1, 2);
    await th.openTrove_allAccounts(
      _1_Defaulter,
      contracts,
    ...
    // Check initial troves with starting 10E/90STAR, and whale's trove, are still open
    for (account of accounts.slice(101, 111)) {
      assert.isTrue(await sortedTroves.contains(account));
    }
    assert.isTrue(await sortedTroves.contains(whale));

    //Check STAR in SP has decreased but is still > 0
    const STARinSP_After = await stabilityPool.getTotalSTARDeposits();
    assert.isTrue(STARinSP_After.lt(web3.utils.toBN(dec(9, 28))));
    assert.isTrue(STARinSP_After.gt(web3.utils.toBN("0")));
  ...
  it("", async () => {
    ...
    //2 acct opens Trove with 1 ether and withdraw 100 STAR
    const _2_Defaulters = accounts.slice(1, 3);
    await th.openTrove_allAccounts(
      _2_Defaulters,
      contracts,
  ...
  it("", async () => {
    ...
    // Account 500 opens with 1 ether and withdraws 110 STAR
    await borrowerOperations.openTrove(
      _100pct,
      dec(110, 18),
      accounts[500],
  ...
  it("", async () => {
    ...
    // Account 500 opens with 1 ether and withdraws 180 STAR
    await borrowerOperations.openTrove(
      _100pct,
      dec(130, 18),
      accounts[500],
  ...
  it("", async () => {
    ...
    await borrowerOperations.openTrove(
      ...
      accounts[999],
      ZERO_ADDRESS,
      { from: accounts[999], value: dec(1, 27) }
    );
