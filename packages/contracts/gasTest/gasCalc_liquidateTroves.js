...
contract("Gas cost tests", async (accounts) => {
  ...
  it("", async () => {
    ...
    // 10 accts each open Trove with 10 ether, withdraw 100 STAR
  ...
  it("", async () => {
    ...
    //50 accts open Trove with 1 ether and withdraw 100 STAR
  ...
  it("", async () => {
    ...
    //60 accts open Trove with 1 ether and withdraw 100 STAR
  ...
  it("", async () => {
    ...
    // 10 accts each open Trove with 15 ether, withdraw 100 STAR
    await th.openTrove_allAccounts(
      accounts.slice(101, 111),
      contracts,
      dec(15, "ether"),
    ...
    //65 accts open Trove with 1 ether and withdraw 100 STAR
  ...
  it("", async () => {
    ...
    assert.equal(await stabilityPool.getTotalSTARDeposits(), dec(1, 27));
