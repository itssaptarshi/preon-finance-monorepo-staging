...
const deployDysonUSDPlusVault = require('../../../scripts/deployDysonVaults/deployDysonUSDPlusVault')
...
const IusdPlusConfig = {
    vaultContractName: "DysonVault",
    strategyContractName: "DysonUSDPlusStrategy",
    // bigDeposit: parseUnits("1", 28),
    deposit: parseUnits("0.01", "6"),
    lowDeposit: parseUnits("0.00001", "ether"),
    whaleAddress: "0xF3B8406d7b827e99Ede9Bd1dFfb43Cda17582001",
}

const config = IusdPlusConfig
...
describe("Test", () => {
    ...
    before(async () => {
        ...
        var deployAddresses = await deployDysonUSDPlusVault();
        // TODO:
