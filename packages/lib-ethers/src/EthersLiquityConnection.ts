...
const connectionFrom = (
  ...
  return branded({
    ...
    totalStabilityPoolYETIReward: Decimal.from(totalStabilityPoolYETIReward),
    liquidityMiningYETIRewardRate: Decimal.from(liquidityMiningYETIRewardRate),
    pngLiquidityMiningYETIRewardRate: Decimal.from(pngLiquidityMiningYETIRewardRate),
    tjLiquidityMiningYETIRewardRate: Decimal.from(tjLiquidityMiningYETIRewardRate),
    ...deployment,
    ...optionalParams
  });
};
...
export interface EthersLiquityConnectionOptionalParams {
   ...
   * @remarks
   * For example
   * {@link EthersLiquity.depositYUSDInStabilityPool | depositYUSDInStabilityPool(amount, frontendTag?)}
