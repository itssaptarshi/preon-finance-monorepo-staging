...
import yusdTokenAbi from "../abi/YUSDToken.json";
...
import yetiTokenAbi from "../abi/YETIToken.json";
...
import yetiControllerAbi from "../abi/YetiController.json";
import farmAbi from "../abi/Farm.json";
import veYETIEmissionsAbi from "../abi/VeYETIEmissions.json";
import veYETIAbi from "../abi/VeYETI.json";
...
export interface _LiquityContracts {
  ...
  gasPool: GasPool;
  yusdToken: any; //YUSDToken;
  yetiToken: any; //LQTYToken;
  multiTroveGetter: MultiTroveGetter;
  yetiController: any; //YetiController;
  farm: any; //Farm;
  boostedFarm: any; //BoostedFarm;
  veYETI: any; //VeYETI;
  veYETIEmissions: any; //VeYetiEmissions;
  lpToken: IERC20; //LPToken;
  YUSDPriceFeed: any; //PriceFeed;
}

export const _getYetiVaultToken = (
  address: string,
  signerOrProvider: EthersSigner | EthersProvider
): any => {
  return {
...
const getAbi = (priceFeedIsTestnet: boolean): LiquityContractAbis => ({
  ...
  yetiController: yetiControllerAbi,
  farm: farmAbi,
  boostedFarm: boostedFarmAbi,
  veYETI: veYETIAbi,
  veYETIEmissions: veYETIEmissionsAbi,
  lpToken: iERC20Abi,
  YUSDPriceFeed: priceFeedIsTestnet ? priceFeedTestnetAbi : priceFeedAbi
});
...
export interface _LiquityDeploymentJSON {
  ...
  readonly liquidityMiningYETIRewardRate: any;
  totalStabilityPoolYETIReward;
  pngLiquidityMiningYETIRewardRate;
  tjLiquidityMiningYETIRewardRate;
