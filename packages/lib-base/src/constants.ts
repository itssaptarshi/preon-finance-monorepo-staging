 ...
 * @public
 */
export const YUSD_LIQUIDATION_RESERVE = Decimal.from(200);

/**
 * A Trove must always have at least this much debt on top of the
 * {@link YUSD_LIQUIDATION_RESERVE | liquidation reserve}.
 *
 * @remarks
 ...
 * @public
 */
export const YUSD_MINIMUM_NET_DEBT = Decimal.from(1800);
 ...
 * @public
 */
export const YUSD_MINIMUM_DEBT = YUSD_LIQUIDATION_RESERVE.add(YUSD_MINIMUM_NET_DEBT);
