 ...
 * {@link @liquity/lib-base#YUSD_MINIMUM_DEBT | minimum debt} requirement that Troves must fulfill,
 * some YUSD amounts are not possible to redeem exactly.
 *
 * When {@link @liquity/lib-base#PopulatableLiquity.redeemYUSD | redeemYUSD()} is called with an
 * amount that can't be fully redeemed, the amount will be truncated (see the `redeemableYUSDAmount`
 ...
 * {@link @liquity/lib-base#YUSD_MINIMUM_NET_DEBT}.
 *
 * @public
 */
export interface PopulatedRedemption<P = unknown, S = unknown, R = unknown>
  ...
  /** Whether `redeemableYUSDAmount` is less than `attemptedYUSDAmount`. */
...
export interface PopulatableLiquity<R = unknown, S = unknown, P = unknown>
  ...
  /** {@inheritDoc TransactableLiquity.borrowYUSD} */
  borrowYUSD(
    amount: Decimalish,
    maxBorrowingRate?: Decimalish
  ): Promise<
  ...
  /** {@inheritDoc TransactableLiquity.repayYUSD} */
  repayYUSD(
    amount: Decimalish
  ): Promise<
    PopulatedLiquityTransaction<
  ...
  /** {@inheritDoc TransactableLiquity.depositYUSDInStabilityPool} */
  ...
  /** {@inheritDoc TransactableLiquity.withdrawYUSDFromStabilityPool} */
  ...
  /** {@inheritDoc TransactableLiquity.sendYUSD} */
  sendYUSD(
    toAddress: string,
    amount: Decimalish
  ): Promise<PopulatedLiquityTransaction<P, SentLiquityTransaction<S, LiquityReceipt<R, void>>>>;
  ...
  /** {@inheritDoc TransactableLiquity.redeemYUSD} */
  redeemYUSD(
    amount: Decimalish,
    maxRedemptionRate?: Decimalish
  ): Promise<PopulatedRedemption<P, S, R>>;
