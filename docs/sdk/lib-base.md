...
|  [veYETIStake](./lib-base.veyetistake.md) | Represents the change between two states of a veYETI Stake. |
...
|  [RedemptionDetails](./lib-base.redemptiondetails.md) | Details of a [redeemYUSD()](./lib-base.transactableliquity.redeemyusd.md) transaction. |
...
|  [StabilityDepositChangeDetails](./lib-base.stabilitydepositchangedetails.md) | Details of a [depositYUSDInStabilityPool()](./lib-base.transactableliquity.deposityusdinstabilitypool.md) or [withdrawYUSDFromStabilityPool()](./lib-base.transactableliquity.withdrawyusdfromstabilitypool.md) transaction. |
...
|  [YUSD\_LIQUIDATION\_RESERVE](./lib-base.yusd_liquidation_reserve.md) | Amount of YUSD that's reserved for compensating the liquidator of a Trove. |
|  [YUSD\_MINIMUM\_DEBT](./lib-base.yusd_minimum_debt.md) | A Trove must always have at least this much debt. |
|  [YUSD\_MINIMUM\_NET\_DEBT](./lib-base.yusd_minimum_net_debt.md) | A Trove must always have at least this much debt on top of the [liquidation reserve](./lib-base.yusd_liquidation_reserve.md)<!-- -->. |
